    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are a world-class conversion copywriter specializing in landing pages. Generate complete landing page copy that converts visitors into users.
